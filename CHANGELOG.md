...
- Исправлено отсутствие стилизации Alert-окон
- *(start)* Расширен охват try-catch с IOException на Exception
...
- *(MainController)* Показ ошибки при Exception перенесен в отдельный метод
